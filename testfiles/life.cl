...
class CellularAutomaton inherits Board {
	...
	(let num : Int <- board_size in
	{
	 ...
	 while i < num loop
           {
	    out_string(population_map.substring(i,i + columns));
	    out_nl(); 
	    i <- i + columns;
	   }
	 pool;
	...
	if board_size - 1 < position then
		" "
        	...
        	population_map.substring(position, position +1)
	fi
    };
...
--   3x5, 4x5, 5x5, 3x7, 7x4, 4x4 with the row first then column. 
 ...
 option(): String {
 {
  (let num : Int in
   {
   out_nl();
   out_string("Please chose a number:"); out_nl();
   out_string("1: A cross"); out_nl();
   out_string("2: A slash from the upper left to lower right"); out_nl();
   out_string("3: A slash from the upper right to lower left"); out_nl();
   out_string("4: An X"); out_nl();
   out_string("5: A greater than sign"); out_nl();
   out_string("6: A less than sign"); out_nl();
   out_string("7: Two greater than signs"); out_nl();
   out_string("8: Two less than signs"); out_nl();
   out_string("9: A 'V'"); out_nl();
   out_string("10: An inverse 'V'"); out_nl();
   out_string("11: Numbers 9 and 10 combined"); out_nl();
   out_string("12: A full grid"); out_nl();
   out_string("13: A 'T'"); out_nl();
   out_string("14: A plus '+'"); out_nl();
   out_string("15: A 'W'"); out_nl();
   out_string("16: An 'M'"); out_nl();
   out_string("17: An 'E'"); out_nl();
   out_string("18: A '3'"); out_nl();
   out_string("19: An 'O'"); out_nl();
   out_string("20: An '8'"); out_nl();
   out_string("21: An 'S'"); out_nl();
